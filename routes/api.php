...
//     return $request->user();
// });
Route::post('editmanageprofile/{id}', 'Api\MainController@editManageProfile');
 ...
 Route::post('addcomment', 'Api\RatingCommentController@comment_store');
  ...
  Route::post('Kingspay_subscription_api', 'Api\Kingpay@Kingspay_subscription_api');
...
Route::group(['middleware' => ['auth:api','is_blocked']], function (){
  ...
  Route::get('verifycoupon', 'Api\MainController@verify_coupon');
