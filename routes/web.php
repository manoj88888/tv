...
//Route::get('test','TestController@sendNotification');
...
// Route::post('editmanageprofile/{id}', 'TestController@editManageProfile');

Route::get("newdesignpage", 'TestController@newDesign');
Route::get("account/newpackagedesign", 'TestController@newPackageDesign');
Route::get("new-home-design", 'TestController@newHomwDesign');
Route::post('sendmyotp/{id}', 'TestController@sendMyOTP');
Route::post('update-my-email/{id}', 'TestController@updateMyEmail');


Route::post('paywithkingspay', 'UserAccountController@paywithKingsPay');
...
Route::middleware(['IsInstalled','isActive' ,'switch_languages', 'ip_block','comming_soon'])->group(function (){
    ...
    Route::group(['middleware' => ['web', 'auth' ,'switch_languages']], function () {
      ...
      Route::post('sendmyotp/{id}', 'UserAccountController@sendMyOTP');
      Route::post('update-my-email/{id}', 'UserAccountController@updateMyEmail');
      ...
      Route::post('account/profile/namegender','UsersController@update_name_gender');
    ...
    Route::get('user/vip-subscription/{plan_id}/{coupon_id}', 'UsersController@vipSubscription')->name('vip_subscription');
    ...
    Route::group(['middleware' => ['web', 'auth', 'is_subscriber', 'login_limit','switch_languages']], function () {
      ...
      Route::post('user/notification-read', 'NotificationController@notificationreadAll')->name('notificationreadAll');
      ...
      Route::get('audio/detail/{id}', 'PrimeDetailController@audioshow')->name('watchRadio');
