...
<head>
  ...
  <link rel="stylesheet" href="{{ url('css/new_profilepage_design/style.css') }}" />
  <link rel="stylesheet" href="{{ url('css/new_profilepage_design/bootstrap.min.css') }}" />
          ...
          <ul>
            ...
            <li> 
              <div id="ex4" class="dropdown prime-dropdown">
                ...
                <span class="p1 fa-stack fa-2x has-badge dropdown-toggle count-firebasemessage" type="button" data-toggle="dropdown" data-count="0">
                ...
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-user-circle"></i> @if(Session::has('nickname')) {{ Session::get('nickname') }} @else {{$auth ? $auth->name : ''}} @endif
                  ...
                  <ul class="dropdown-menu prime-dropdown-menu">
                    ...
                    @endif
                     ...
                     @if($catlog == 0 && $subscribed == 1)
                      ...
                      @elseif($catlog ==1)
                        ...
                        @endif
                      @endif
                    <li><a href="{{url('account')}}">{{__('staticwords.account')}}</a></li>
                    ...
                    @if(isset(Auth::user()->paypal_subscriptions) && $subscribed == 1)
                      <li><a href="{{ url('/manageprofile/mus/'.Auth::user()->id)}} ">{{__('staticwords.manageprofiles')}}</a></li>
                    @endif
                      @php
    ...
    <div class="text-center">
      ...
      <div class="footer-widgets social-widgets social-btns">
        <ul>
          ...
          @if(isset($si->url2))<li><a href="{{ $si->url2 }}" target="_blank"><i class="fa fa-weixin"></i></a></li>@endif
...
{{-- <script type="text/javascript" src="{{ url('js/new_profilepage_design/bootstrap.bundle.min.js') }}"></script> --}}
...
<script type="text/javascript">
 ...
 function readedAll(notification){
  /*alert(notification);*/
   /*$.ajax({
    type : 'POST',
    data : {  "_token": "{{ csrf_token() }}",id:notification },
    url  : "{{route('notificationreadAll')}}",
    success :function(data){
      location.reload();
    }
  });*/
...
<script>
  ...
  // Initialize Firebase
  /*var firbaseconfig = {
    apiKey: "AIzaSyBOfeq05Q7snF-W0sORgPvQbGVN-K5Fh6k",
    authDomain: "sg-driver-test.firebaseapp.com",
    databaseURL: "https://sg-driver-test.firebaseio.com",
    projectId: "sg-driver-test",
    storageBucket: "sg-driver-test.appspot.com",
    messagingSenderId: "1094318273650"
  };*/
  var firbaseconfig = {
    apiKey: "AIzaSyDbeGZxVCxTx3hl1RXDD5s2qrNRvF2yCyA",
    authDomain: "alphatv-584b0.firebaseapp.com",
    databaseURL:"https://alphatv-584b0-default-rtdb.firebaseio.com",
    projectId: "alphatv-584b0",
    storageBucket: "alphatv-584b0.appspot.com",
    messagingSenderId: "831850912216",
    //appId: "1:831850912216:web:dc023e4baed2b6816e7aad",
    //measurementId: "G-8MSNMK812Y"
  };
  firebase.initializeApp(firbaseconfig);
  var loginuser =  "{{ (auth()->check()) ? Auth::user()->id : ''  }}";
