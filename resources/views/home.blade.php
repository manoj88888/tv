    ...
    @if($menu->slug != 'home')
        @if($section->section_id == 1 && $recentlyadded != NULL && count($recentlyadded) >0)
            ...
            <div class="container-fluid">
               ...
               <h5 class="section-heading">{{ $menu->name }}</h5>
      ...
      @if(isset($tvshows) && count($tvshows)>0)
       <div class="genre-prime-block">
          <div class="container-fluid">
            ...
            @if($auth && $subscribed==1)
                <a href="https://app.alphatv.global/viewall/5/TV" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
            @else
                <a href="https://app.alphatv.global/viewall/5/TV" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
            @endif
            ...
            <div class="genre-prime-slider owl-carousel">
              @foreach($tvshows as $tv)
                  <div class="genre-prime-slide">
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog{{$tv->id}}">
                    @if($auth && $subscribed ==1)
                      <a href="{{url('movie/detail/'.$tv->slug)}}">
                        @if($tv->thumbnail != null)
                          <img data-src="{{ asset('images/movies/thumbnails/'.$tv->thumbnail) }}" class="img-responsive owl-lazy" alt="audio-image">
                        @else
                          <img data-src="{{asset('images/default-thumbnail.jpg')}}" class="img-responsive owl-lazy" alt="blog-image">
                        @endif
                      </a>
                      @else
                        <a href="{{url('movie/guest/detail/'.$tv->slug)}}">
                        @if($tv->thumbnail != null)
                          <img data-src="{{ asset('images/movies/thumbnails/'.$tv->thumbnail) }}" class="img-responsive owl-lazy" alt="audio-image">
                        @else
                          <img data-src="{{asset('images/default-thumbnail.jpg')}}" class="img-responsive owl-lazy" alt="blog-image">
      ...
      @if(isset($movie) && count($movie)>0)
       <div class="genre-prime-block">
          <div class="container-fluid">
            ...
            @if($auth && $subscribed==1)
                <a href="https://app.alphatv.global/viewall/3/Movies" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
            @else
                <a href="https://app.alphatv.global/viewall/3/Movies" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
            @endif
            ...
            <div class="genre-prime-slider owl-carousel">
              @foreach($movie as $movies)
                  <div class="genre-prime-slide">
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog{{$movies->id}}">
                      @if($auth && $subscribed ==1)
                      <a href="{{url('movie/detail/'.$movies->slug)}}">
                        @if($movies->thumbnail != null)
                          <img data-src="{{ asset('images/movies/thumbnails/'.$movies->thumbnail) }}" class="img-responsive owl-lazy" alt="audio-image">
                        @else
                          <img data-src="{{asset('images/default-thumbnail.jpg')}}" class="img-responsive owl-lazy" alt="blog-image">
                        @endif
                      </a>
                      @else
                        <a href="{{url('movies/guest/detail/'.$movies->slug)}}">
                        @if($movies->thumbnail != null)
                          <img data-src="{{ asset('images/movies/thumbnails/'.$movies->thumbnail) }}" class="img-responsive owl-lazy" alt="audio-image">
                        @else
                          <img data-src="{{asset('images/default-thumbnail.jpg')}}" class="img-responsive owl-lazy" alt="blog-image">
      ...
      @if(isset($program) && count($program)>0)
       <div class="genre-prime-block">
          <div class="container-fluid">
            ...
            @if($auth && $subscribed==1)
                <a href="https://app.alphatv.global/viewall/4/Program" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
            @else
                <a href="https://app.alphatv.global/viewall/4/Program" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
            @endif
            ...
            @foreach($program as $programs)
                <div class="genre-prime-slide">
                <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog{{$programs->id}}">
                  @if($auth && $subscribed == 1)
                    <a href="{{url('show/detail/'.$programs->season_slug)}}">
                    @if($programs->thumbnail != null)
                      <img data-src="{{ asset('images/tvseries/thumbnails/'.$programs->thumbnail) }}" class="img-responsive owl-lazy" alt="audio-image">
                    @else
                      <img data-src="{{asset('images/default-thumbnail.jpg')}}" class="img-responsive owl-lazy" alt="blog-image">
                    @endif
                  </a>
                  @else
                    <a href="{{url('show/guest/detail/'.$programs->season_slug)}}">
                    @if($programs->thumbnail != null)
                      <img data-src="{{ asset('images/tvseries/thumbnails/'.$programs->thumbnail) }}" class="img-responsive owl-lazy" alt="audio-image">
                    @else
                      <img data-src="{{asset('images/default-thumbnail.jpg')}}" class="img-responsive owl-lazy" alt="blog-image">
...
<!--------------------- Audio ------------------------->
    @if($menu->slug == 'radio' || $menu->slug == 'home')
      @if(isset($audio) && count($audio)>0)
       <div class="genre-prime-block">
              ...
              <div class="container-fluid">
                ...
                @if($auth && $subscribed==1)
                    <a href="https://app.alphatv.global/viewall/6/Radio" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
                @else
                    <a href="https://app.alphatv.global/viewall/6/Radio" class="see-more"> <b>{{ __('staticwords.viewall')}}</b></a>
                @endif
            @endif
              ...
              @foreach($audio as $audios)
                  <div class="genre-prime-slide">
                    ...
                    @if($menu->slug == 'radio')
                        ...
                        <ul class="description-list">
                          <li>{{__('staticwords.tmdbrating')}} {{$audios->rating}}</li>
                          <li>{{$audios->duration}} {{__('staticwords.mins')}}</li>
                          <li>{{$audios->publish_year}}</li>
                          <li>{{$audios->maturity_rating}}</li>
                        </ul>
                    
                        <div class="main-des">
                          <p>{{str_limit($audios->detail,100,'...')}}</p>
                          @if($auth && $subscribed == 1)
                            <a href="{{url('audio/detail',$audios->id)}}">{{__('staticwords.readmore')}}</a>
                          @else
                             <a href="{{url('audio/guest/detail',$audios->id)}}">{{__('staticwords.readmore')}}</a>
                          @endif
                        </div> 
                        <div class="des-btn-block">
                            @if($auth && $subscribed==1)
                                @if($audios->maturity_rating == 'all age' || $age>=str_replace('+', '', $audios->maturity_rating))
                                    @if($audios->video_link['iframeurl'] != null)
                                        <a href="{{ route('watchaudio',$audios->id)}}"class="btn btn-play iframe"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"> {{__('staticwords.playnow')}}</span>
                                      </a>
                                    @else
                                        <a href="{{ route('watchaudio',$audios->id)}}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"> {{__('staticwords.playnow')}}</span>
                                        </a>
                                    @endif
                                @else
                                    <a onclick="myage({{$age}})" class=" btn btn-play play-btn-icon"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span></a>
                                @endif
                                @if($audios->trailer_url != null || $audios->trailer_url != '')
                                    <a class="iframe btn btn-default" href="{{ route('watchTrailer',$audios->id) }}">{{__('staticwords.watchtrailer')}}</a>
                                @endif
                            @else
                                @if($audios->trailer_url != null || $audios->trailer_url != '')
                                    <a class="iframe btn btn-default" href="{{ route('guestwatchtrailer',$audios->id) }}">{{__('staticwords.watchtrailer')}}</a>
                                @endif
                            @endif
                            
                            @if($catlog == 0 && $subscribed == 1)
                                @if (isset($wishlist_check->added))
                                  <button onclick="addWish({{$audios->id}},'{{$item->type}}')" class="addwishlistbtn{{$audios->id}}{{$audios->type}} btn-default">{{$wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')}}</button>
                                @else
                                  <button onclick="addWish({{$audios->id}},'{{$item->type}}')" class="addwishlistbtn{{$audios->id}}{{$audios->type}} btn-default">{{__('staticwords.addtowatchlist')}}</button>
                                @endif
                            @elseif($catlog == 1)
                                @if($auth)
                                    @if (isset($wishlist_check->added))
                                        <button onclick="addWish({{$audios->id}},'{{$audios->type}}')" class="addwishlistbtn{{$audios->id}}{{$audios->type}} btn-default">{{$wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')}}</button>
                                    @else
                                        <button onclick="addWish({{$audios->id}},'{{$audios->type}}')" class="addwishlistbtn{{$audios->id}}{{$audios->type}} btn-default">{{__('staticwords.addtowatchlist')}}</button>
                                    @endif
                                @endif
                            @endif
                        </div>
