                                ...
                                <div class="cus_img">
                                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$item->id}}">
                                        @if($auth && $subscribed ==1)
                                            ...
                                            <a href="{{url('audio/detail',$item->id)}}">
                                                @if($item->thumbnail != null || $item->thumbnail != '')
                                                    <img data-src="{{url('images/audio/thumbnails/'.$item->thumbnail)}}" class="img-responsive lazy" alt="genre-image">
                                                @else
                                                    <img data-src="{{url('images/default-thumbnail.jpg')}}" class="img-responsive lazy" alt="genre-image">
                                                @endif
                                            </a>
                                        @else
                                            <a href="{{url('audio/guest/detail',$item->id)}}">
                                                @if($item->tvseries->thumbnail != null || $item->tvseries->thumbnail != '')
                                                    <img data-src="{{url('images/audio/thumbnails/'.$item->thumbnail)}}" class="img-responsive lazy" alt="genre-image">
                                                @else
                                                    <img data-src="{{url('images/default-thumbnail.jpg')}}" class="img-responsive lazy" alt="genre-image">
                                    ...
                                    <div id="prime-next-item-description-block{{$item->id}}" class="prime-description-block">
                                        ...
                                        <div class="main-des">
                                            ...
                                            @endif
                                            @if($auth && $subscribed == 1)
                                            <a href="{{url('audio/detail',$item->id)}}">{{__('staticwords.readmore')}}</a>
                                            @else
                                            <a href="{{url('audio/guest/detail',$item->id)}}">{{__('staticwords.readmore')}}</a>
                                            @endif
                                        </div>
                                        <div class="des-btn-block">
                                            @if($subscribed==1 && $auth)
                                                @if($item->maturity_rating =='all age' || $age>=str_replace('+', '', $item->maturity_rating))
                                                    @if($item->video_link['iframeurl'] != null)
                                                        <a href="{{route('watchaudio',$item->id)}}"class="btn btn-play iframe"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                                                    </a>
                                                    @else 
                                                        <a href="{{route('watchaudio',$item->id)}}" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span></a>
                                                    @endif
                                                @else
                                                    <a onclick="myage({{$age}})" class="btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                                                    </a>
