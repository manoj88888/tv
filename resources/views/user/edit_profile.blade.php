        ...
        <div class="row">
            <div class="col-md-6">
                <div class="edit-profile-block">
                    ...
                    {!! Form::open(['method' => 'POST', 'action' => 'UsersController@update_name_gender']) !!}
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <input type="text" class="form-control"  name="name"  @if(isset(Auth::user()->name)) value="{{Auth::user()->name}}" @endif/>
