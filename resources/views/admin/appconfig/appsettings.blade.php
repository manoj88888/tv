    ...
    <div class="col-md-6" style="opacity:0.5;">
        ...
        <div class="payment-gateway-block">
          <div class="form-group">
            <div class="row">
              <div class="col-xs-6">
                {!! Form::label('amazon_lab_check',__('adminstaticwords.EnableAmazonLogin:')) !!}
              </div>
          ...
          <div style="{{ $appconfig->interstitial_admob==1 ? "" : "display: none" }}" id="interstitial_box" class="row">
            <div class="col-md-12">
              <div class="form-group{{ $errors->has('interstitial_id') ? ' has-error' : '' }}">
                ...
                <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="{{__('adminstaticwords.PleasEnterInterstitialAdmobID')}}"></i>
