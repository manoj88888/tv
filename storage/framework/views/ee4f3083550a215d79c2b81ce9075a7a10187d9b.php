...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(url('css/new_profilepage_design/style.css')); ?>" />
  <link rel="stylesheet" href="<?php echo e(url('css/new_profilepage_design/bootstrap.min.css')); ?>" />
                ...
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-user-circle"></i> <?php if(Session::has('nickname')): ?> <?php echo e(Session::get('nickname')); ?> <?php else: ?> <?php echo e($auth ? $auth->name : ''); ?> <?php endif; ?>
                  ...
                  <ul class="dropdown-menu prime-dropdown-menu">
                    ...
                    <?php endif; ?>
                     ...
                     <?php if($catlog == 0 && $subscribed == 1): ?>
                      ...
                      <?php elseif($catlog ==1): ?>
                        ...
                        <?php endif; ?>
                      <?php endif; ?>
                    <li><a href="<?php echo e(url('account')); ?>"><?php echo e(__('staticwords.account')); ?></a></li>
                    ...
                    <?php if(isset(Auth::user()->paypal_subscriptions) && $subscribed == 1): ?>
                      <li><a href="<?php echo e(url('/manageprofile/mus/'.Auth::user()->id)); ?> "><?php echo e(__('staticwords.manageprofiles')); ?></a></li>
                    <?php endif; ?>
                      <?php
    ...
    <div class="text-center">
      ...
      <div class="footer-widgets social-widgets social-btns">
        <ul>
          ...
          <?php if(isset($si->url2)): ?><li><a href="<?php echo e($si->url2); ?>" target="_blank"><i class="fa fa-weixin"></i></a></li><?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\tv\resources\views/layouts/theme.blade.php ENDPATH**/ ?>