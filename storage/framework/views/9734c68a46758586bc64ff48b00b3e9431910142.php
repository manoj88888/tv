...
<?php $__env->startSection('title',__('adminstaticwords.CreateBlock')); ?>
<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/customize/landing-page')); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('adminstaticwords.GoBack')); ?>" class="btn-floating"><i class="material-icons">reply</i></a> <?php echo e(__('adminstaticwords.CreateBlock')); ?></h4>
    <div class="row">
      <div class="col-md-6">
        <div class="admin-form-block z-depth-1">
          <?php echo Form::open(['method' => 'POST', 'action' => 'LandingPageController@store', 'files' => true]); ?>
            ...
            <div class="form-group<?php echo e($errors->has('heading') ? ' has-error' : ''); ?>">
                ...
                <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('adminstaticwords.PleaseEnterHeading')); ?> eg:Join next hour"></i>
                <?php echo Form::text('heading', null, ['class' => 'form-control', 'placeholder'=>__('adminstaticwords.PleaseEnterHeading')]); ?>
            ...
            <div class="form-group<?php echo e($errors->has('detail') ? ' has-error' : ''); ?>">
                ...
                <?php echo Form::textarea('detail', null, ['class' => 'form-control materialize-textarea', 'placeholder'=>__('adminstaticwords.PleaseEnterDetail')]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/landing-page/create.blade.php ENDPATH**/ ?>