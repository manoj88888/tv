      ...
      <table id="genreTable" class="table table-hover" style="width:100%">
        <thead>
          <tr class="table-heading-row">
            ...
            <th><?php echo e(__('adminstaticwords.Sort')); ?></th>
            <th><?php echo e(__('adminstaticwords.Image')); ?></th>
            <th><?php echo e(__('adminstaticwords.GenreName')); ?></th>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/genre/index.blade.php ENDPATH**/ ?>