...
<?php $__env->startSection('title',__('adminstaticwords.AllRevenueReport')); ?>
            ...
            <tbody>
              <?php $__currentLoopData = $revenue_report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="item-<?php echo e($report->id); ?>">
                  ...
                  <td><?php echo e($report->coupon); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/report/revenue.blade.php ENDPATH**/ ?>