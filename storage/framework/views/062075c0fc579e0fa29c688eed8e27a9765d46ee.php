        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              ...
              <p><?php echo e(__('adminstaticwords.DeleteWarnning')); ?></p>
            </div>
      ...
      <table id="moviesTable" class="table table-hover">
        <thead>
          <tr class="table-heading-row">
            ...
            <th><?php echo e(__('adminstaticwords.LiveTvTitle')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/livetv/addedindex.blade.php ENDPATH**/ ?>