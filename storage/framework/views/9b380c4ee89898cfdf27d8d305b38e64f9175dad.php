                ...
                <?php if($plan->id%2 != 0): ?>
                    <div class="col-md-6 col d-flex flex-lg-row flex-column align-items-center justify-content-center">
                        <div class="bbb_deals" style="background-color: rgba(219,205,240,255); padding-top: 30px; width: 270px; height: 530px;">
                            ...
                            <?php endif; ?>
                            <p style="font-size: large; text-align: center; font-weight: 700;"><?php echo e($plan->name); ?></p>
                            <div class="bbb_deals_slider_container">
                                <div class=" bbb_deals_item">
                                    <div class="bbb_deals_image image1"><img src="<?php echo e(url('images/new_package_design/1.png')); ?>" alt=""></div>
                                    <div class="bbb_deals_content">
                                        <p style="font-size: large; text-align: center; font-weight: 400;"><b>$</b> <?php echo e($plan->amount); ?> / <?php echo e($plan->interval); ?> </p>
                                            <p style="font-size: small; text-align: center;">
                                                <b>
                                                    <?php echo e($plan->title1); ?><br>
                                                    <?php echo e($plan->title2); ?><br>
                                                    <?php echo e($plan->title3); ?><br>
                                                    <?php echo e($plan->title4); ?><br>
                                                    <?php echo e($plan->title5); ?><br>
                                                    <?php echo e($plan->title6); ?>

                                                </b>
                                            </p>
                                        <img class="image2" src="<?php echo e(url('images/new_package_design/yes.png')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col d-flex flex-lg-row flex-column align-items-center justify-content-center">
                        <div class="bbb_deals" style="background-color: rgb(53, 53, 53); padding-top: 30px; width: 270px; height: 530px;">
                            <?php if($plan->interval == 'year'): ?>
                                <div style="font-size: small;" class="ribbon ribbon-top-right"><span>Recommended</span></div>
                            <?php endif; ?>
                            <p style="font-size: large; text-align: center; font-weight: 700; color: white;"><?php echo e($plan->name); ?></p>
                            <div class="bbb_deals_slider_container">
                                <div class=" bbb_deals_item">
                                    <div class="bbb_deals_image image1"><img src="<?php echo e(url('images/new_package_design/2.png')); ?>" alt=""></div>
                                    <div class="bbb_deals_content">
                                        <p class="onhover" style="font-size: large; text-align: center; font-weight: 400; color: white;"><b>$</b><?php echo e($plan->amount); ?> / <?php echo e($plan->interval); ?></p>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/user/new_purchaseplan.blade.php ENDPATH**/ ?>