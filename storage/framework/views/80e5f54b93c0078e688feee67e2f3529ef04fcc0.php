  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div id="movie_title" class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
        ...
        <?php echo Form::text('title', null, ['class' => 'form-control', 'placeholder' => __('adminstaticwords.PleaseEnterMovieTitle')]); ?>
      ...
      <div id="movie_id" style="display: none;" class="form-group<?php echo e($errors->has('title2') ? ' has-error' : ''); ?>">
        ...
        <?php echo Form::text('title2', null, ['class' => 'form-control', 'placeholder' =>__('adminstaticwords.PleaseEnterMovieID')]); ?>
...
<div id="custom_dtl" class="custom-dtl">
  ...
  <div class="form-group<?php echo e($errors->has('duration') ? ' has-error' : ''); ?>">
    ...
    <?php echo Form::text('duration', null, ['class' => 'form-control', 'placeholder'=>__('adminstaticwords.PleaseEnterDurationInMins')]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/movie/create.blade.php ENDPATH**/ ?>