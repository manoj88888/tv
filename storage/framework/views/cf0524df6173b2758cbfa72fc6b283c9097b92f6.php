                    ...
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog<?php echo e($audios->id); ?>">
                      ...
                      <a href="<?php echo e(url('audio/detail/'.$audios->id)); ?>">
                        <?php if($audios->thumbnail != null): ?>
                          <img data-src="<?php echo e(asset('images/audio/thumbnail/'.$audios->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                        <?php else: ?>
                          <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
                        <?php endif; ?>
                      </a>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sonaflix/new.sonaflix.com/resources/views/home.blade.php ENDPATH**/ ?>