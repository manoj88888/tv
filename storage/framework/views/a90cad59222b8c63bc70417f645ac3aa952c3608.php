    ...
    <?php if($menu->slug != 'home'): ?>
        <?php if($section->section_id == 1 && $recentlyadded != NULL && count($recentlyadded) >0): ?>
            ...
            <div class="container-fluid">
               ...
               <h5 class="section-heading"><?php echo e($menu->name); ?></h5>
    ...
    <?php
        ...
        foreach ($menu_data as $key => $item) {
           $ftvs = App\TvSeries::
            ...
            $tempfeatured = array_values(array_filter($featuresitems));
            if(count($tempfeatured) == $section->item_limit+1) {
                break;
                exit();
            }
...
<!--------------------- TV ------------------------->
    <?php if($menu->slug == 'home'): ?>
      <?php if(isset($tvshows) && count($tvshows)>0): ?>
       <div class="genre-prime-block">
          <div class="container-fluid">
            <h5 class="section-heading"> LIVE TV CHANNELS </h5>
            
            <?php if($auth && $subscribed==1): ?>
                <a href="https://app.alphatv.global/viewall/5/TV" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
            <?php else: ?>
                <a href="https://app.alphatv.global/viewall/5/TV" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
            <?php endif; ?>
            
            <div class="genre-prime-slider owl-carousel">
              <?php $__currentLoopData = $tvshows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="genre-prime-slide">
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog<?php echo e($tv->id); ?>">
                    <?php if($auth && $subscribed ==1): ?>
                      <a href="<?php echo e(url('movie/detail/'.$tv->slug)); ?>">
                        <?php if($tv->thumbnail != null): ?>
                          <img data-src="<?php echo e(asset('images/movies/thumbnails/'.$tv->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                        <?php else: ?>
                          <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
                        <?php endif; ?>
                      </a>
                      <?php else: ?>
                        <a href="<?php echo e(url('movie/guest/detail/'.$tv->slug)); ?>">
                        <?php if($tv->thumbnail != null): ?>
                          <img data-src="<?php echo e(asset('images/movies/thumbnails/'.$tv->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                        <?php else: ?>
                          <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
...
<!--------------------- Movies ------------------------->
    <?php if($menu->slug == 'home'): ?>
      <?php if(isset($movie) && count($movie)>0): ?>
       <div class="genre-prime-block">
          <div class="container-fluid">
            <h5 class="section-heading"> MOVIES </h5>
            
            <?php if($auth && $subscribed==1): ?>
                <a href="https://app.alphatv.global/viewall/3/Movies" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
            <?php else: ?>
                <a href="https://app.alphatv.global/viewall/3/Movies" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
            <?php endif; ?>
            ...
            <div class="genre-prime-slider owl-carousel">
              <?php $__currentLoopData = $movie; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="genre-prime-slide">
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog<?php echo e($movies->id); ?>">
                      <?php if($auth && $subscribed ==1): ?>
                      <a href="<?php echo e(url('movie/detail/'.$movies->slug)); ?>">
                        <?php if($movies->thumbnail != null): ?>
                          <img data-src="<?php echo e(asset('images/movies/thumbnails/'.$movies->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                        <?php else: ?>
                          <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
                        <?php endif; ?>
                      </a>
                      <?php else: ?>
                        <a href="<?php echo e(url('movies/guest/detail/'.$movies->slug)); ?>">
                        <?php if($movies->thumbnail != null): ?>
                          <img data-src="<?php echo e(asset('images/movies/thumbnails/'.$movies->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                        <?php else: ?>
                          <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
      ...
      <?php if(isset($program) && count($program)>0): ?>
       <div class="genre-prime-block">
          <div class="container-fluid">
            ...
            <?php if($auth && $subscribed==1): ?>
                <a href="https://app.alphatv.global/viewall/4/Program" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
            <?php else: ?>
                <a href="https://app.alphatv.global/viewall/4/Program" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
            <?php endif; ?>
            ...
            <?php $__currentLoopData = $program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $programs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="genre-prime-slide">
                <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog<?php echo e($programs->id); ?>">
                  <?php if($auth && $subscribed == 1): ?>
                    <a href="<?php echo e(url('show/detail/'.$programs->season_slug)); ?>">
                    <?php if($programs->thumbnail != null): ?>
                      <img data-src="<?php echo e(asset('images/tvseries/thumbnails/'.$programs->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                    <?php else: ?>
                      <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
                    <?php endif; ?>
                  </a>
                  <?php else: ?>
                    <a href="<?php echo e(url('show/guest/detail/'.$programs->season_slug)); ?>">
                    <?php if($programs->thumbnail != null): ?>
                      <img data-src="<?php echo e(asset('images/tvseries/thumbnails/'.$programs->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                    <?php else: ?>
                      <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
...
<!--------------------- Audio ------------------------->
    <?php if($menu->slug == 'radio' || $menu->slug == 'home'): ?>
      <?php if(isset($audio) && count($audio)>0): ?>
       <div class="genre-prime-block">
           
              <div class="container-fluid">
                  <?php if($menu->slug == 'home'): ?>
                <h5 class="section-heading"> RADIO </h5>
                <?php if($auth && $subscribed==1): ?>
                    <a href="https://app.alphatv.global/viewall/6/Radio" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
                <?php else: ?>
                    <a href="https://app.alphatv.global/viewall/6/Radio" class="see-more"> <b><?php echo e(__('staticwords.viewall')); ?></b></a>
                <?php endif; ?>
            <?php endif; ?>
            <div class="genre-prime-slider owl-carousel">
              <?php $__currentLoopData = $audio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audios): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="genre-prime-slide">
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block-blog<?php echo e($audios->id); ?>">
                      <?php if($auth && $subscribed ==1): ?>
                      <a href="<?php echo e(url('audio/detail/'.$audios->id)); ?>">
                        <?php if($audios->thumbnail != null): ?>
                          <img data-src="<?php echo e(asset('images/audio/thumbnails/'.$audios->thumbnail)); ?>" class="img-responsive owl-lazy" alt="audio-image">
                        <?php else: ?>
                          <img data-src="<?php echo e(asset('images/default-thumbnail.jpg')); ?>" class="img-responsive owl-lazy" alt="blog-image">
                        <?php endif; ?>
                      </a>
                    ...
                    <?php if($menu->slug == 'radio'): ?>
                        ...
                        <ul class="description-list">
                          <li><?php echo e(__('staticwords.tmdbrating')); ?> <?php echo e($audios->rating); ?></li>
                          <li><?php echo e($audios->duration); ?> <?php echo e(__('staticwords.mins')); ?></li>
                          <li><?php echo e($audios->publish_year); ?></li>
                          <li><?php echo e($audios->maturity_rating); ?></li>
                        </ul>
                    
                        <div class="main-des">
                          <p><?php echo e(str_limit($audios->detail,100,'...')); ?></p>
                          <?php if($auth && $subscribed == 1): ?>
                            <a href="<?php echo e(url('audio/detail',$audios->id)); ?>"><?php echo e(__('staticwords.readmore')); ?></a>
                          <?php else: ?>
                             <a href="<?php echo e(url('audio/guest/detail',$audios->id)); ?>"><?php echo e(__('staticwords.readmore')); ?></a>
                          <?php endif; ?>
                        </div> 
                        <div class="des-btn-block">
                            <?php if($auth && $subscribed==1): ?>
                                <?php if($audios->maturity_rating == 'all age' || $age>=str_replace('+', '', $audios->maturity_rating)): ?>
                                    <?php if($audios->video_link['iframeurl'] != null): ?>
                                        <a href="<?php echo e(route('watchaudio',$audios->id)); ?>"class="btn btn-play iframe"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"> <?php echo e(__('staticwords.playnow')); ?></span>
                                      </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('watchaudio',$audios->id)); ?>" class="iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"> <?php echo e(__('staticwords.playnow')); ?></span>
                                        </a>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <a onclick="myage(<?php echo e($age); ?>)" class=" btn btn-play play-btn-icon"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"><?php echo e(__('staticwords.playnow')); ?></span></a>
                                <?php endif; ?>
                                <?php if($audios->trailer_url != null || $audios->trailer_url != ''): ?>
                                    <a class="iframe btn btn-default" href="<?php echo e(route('watchTrailer',$audios->id)); ?>"><?php echo e(__('staticwords.watchtrailer')); ?></a>
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if($audios->trailer_url != null || $audios->trailer_url != ''): ?>
                                    <a class="iframe btn btn-default" href="<?php echo e(route('guestwatchtrailer',$audios->id)); ?>"><?php echo e(__('staticwords.watchtrailer')); ?></a>
                                <?php endif; ?>
                            <?php endif; ?>
                            
                            <?php if($catlog == 0 && $subscribed == 1): ?>
                                <?php if(isset($wishlist_check->added)): ?>
                                  <button onclick="addWish(<?php echo e($audios->id); ?>,'<?php echo e($item->type); ?>')" class="addwishlistbtn<?php echo e($audios->id); ?><?php echo e($audios->type); ?> btn-default"><?php echo e($wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')); ?></button>
                                <?php else: ?>
                                  <button onclick="addWish(<?php echo e($audios->id); ?>,'<?php echo e($item->type); ?>')" class="addwishlistbtn<?php echo e($audios->id); ?><?php echo e($audios->type); ?> btn-default"><?php echo e(__('staticwords.addtowatchlist')); ?></button>
                                <?php endif; ?>
                            <?php elseif($catlog == 1): ?>
                                <?php if($auth): ?>
                                    <?php if(isset($wishlist_check->added)): ?>
                                        <button onclick="addWish(<?php echo e($audios->id); ?>,'<?php echo e($audios->type); ?>')" class="addwishlistbtn<?php echo e($audios->id); ?><?php echo e($audios->type); ?> btn-default"><?php echo e($wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')); ?></button>
                                    <?php else: ?>
                                        <button onclick="addWish(<?php echo e($audios->id); ?>,'<?php echo e($audios->type); ?>')" class="addwishlistbtn<?php echo e($audios->id); ?><?php echo e($audios->type); ?> btn-default"><?php echo e(__('staticwords.addtowatchlist')); ?></button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/home.blade.php ENDPATH**/ ?>