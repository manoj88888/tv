...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><?php echo e(__('staticwords.WatchTrailer')); ?> - <?php echo e($season['tvseries']['title']); ?></title>
	...
	<body style="background-color:#999999; padding:0px; margin:0px;">	
		...
		<ul id="playlists" style="display:none;">
		  ...
		  <li data-source="trailer" data-playlist-name="<?php echo e($season['tvseries']['title']); ?>" data-thumbnail-path="<?php echo e(asset('images/movies/thumbnails/'.$season->thumbnail)); ?>">
        ...
        <p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold"><?php echo e(__('staticwords.description')); ?>: </span><?php echo e($season->detail); ?></p>
      	</li>
		...
		<ul id="trailer">
			...
			?>
			<li data-subtitle-soruce="[{source:'<?php echo e(url('subtitles/english_subtitle.txt')); ?>', label:'English'}]" data-thumb-source="<?php echo e(asset('images/movies/thumbnails/'.$season->thumbnail)); ?>" data-video-source="<?php echo e($url); ?>" data-downloadable="yes" data-poster-source="<?php echo e(asset('images/movies/posters/'.$season->poster)); ?>"> 
			    <div data-video-short-description="">
			    	 <p class="minimalDarkCategoriesTitle"><span class="minimialDarkBold"><?php echo e(__('staticwords.title')); ?>: </span><?php echo e($season['title']); ?></p>
        <p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold"><?php echo e(__('staticwords.description')); ?>: </span><?php echo e($season['title']); ?></p>
			    </div>
			</li>
		</ul>
...
<?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/watchtv.blade.php ENDPATH**/ ?>