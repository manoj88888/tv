...
<?php $__env->startSection('title',__('adminstaticwords.CreateAudio')); ?>
<style type="text/css">
  body{
...
<div class="admin-form-main-block">
  <h4 class="admin-form-text"><a href="<?php echo e(url('admin/audio')); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('adminstaticwords.GoBack')); ?>" class="btn-floating"><i class="material-icons">reply</i></a> <?php echo e(__('adminstaticwords.CreateAudio')); ?></h4>
  <div class="row">
     <div class="col-md-6">
     <div class="admin-form-block z-depth-1">

        <?php echo Form::open(['method' => 'POST', 'action' => 'AudioController@store', 'files' => true]); ?>
        ...
        <div id="movie_title" class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
          ...
          <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('adminstaticwords.EnterAudioTitle')); ?> Eg:Avatar"></i>
          <?php echo Form::text('title', null, ['class' => 'form-control', 'placeholder' => __('adminstaticwords.EnterAudioTitle')]); ?>
        ...
        <div class="form-group<?php echo e($errors->has('selecturl') ? ' has-error' : ''); ?>">
          ...
          <?php echo Form::select('selecturl', array('audiourl' => __('adminstaticwords.AudioURL'),
         ...
         <div id="ifbox" style="display: none;" class="form-group">
          ...
          <div class="form-group<?php echo e($errors->has('upload_audio') ? ' has-error' : ''); ?> input-file-block" id="uploadaudio" style="display: none;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/audio/create.blade.php ENDPATH**/ ?>