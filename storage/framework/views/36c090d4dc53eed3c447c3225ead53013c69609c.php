      ...
      <div class="col-md-6">
        <div class="admin-form-block z-depth-1">
          <?php echo Form::open(['method' => 'POST', 'action' => 'CouponController@store']); ?>
        	...
        	<div class="form-group<?php echo e($errors->has('plans') ? ' has-error' : ''); ?>">
  				<?php echo Form::label('duration',__('adminstaticwords.Plans')); ?>

                <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('adminstaticwords.PleaseSelectplan')); ?>"></i>
  				<?php echo Form::select('plans[]',$planData, null, ['class' => 'form-control select2', 'required' => 'required','multiple']); ?>

  				<small class="text-danger"><?php echo e($errors->first('plans')); ?></small>
  			</div>
  			
  			<div class="form-group<?php echo e($errors->has('is_free') ? ' has-error' : ''); ?> switch-main-block">
              <div class="row">
                <div class="col-xs-4">
                  <?php echo Form::label('is_free', 'Is Free ?'); ?>

                </div>
                <div class="col-xs-5 pad-0">
                  <label class="switch">								
                    <?php echo Form::checkbox('is_free', 1, 0, ['class' => 'checkbox-switch', 'id' => 'is_free']); ?>
              ...
              <div class="col-xs-12">
                <small class="text-danger"><?php echo e($errors->first('is_free')); ?></small>
              </div>
            </div>
  			<div class="form-group free-day <?php echo e($errors->has('for_days') ? ' has-error' : ''); ?>" style="display:none;">
                <?php echo Form::label('for_days','Days for free'); ?>

                <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter days for free"></i>
                <?php echo Form::number('for_days', 1, ['class' => 'form-control', 'id' => 'for_days', 'min' => 1]); ?>

                <small class="text-danger"><?php echo e($errors->first('for_days')); ?></small>
            </div>
  ...
  <script>
    ...
    $('#is_free').change(function(){
       if($(this).prop('checked') == true){
           $('.free-day').show();
           $('#for_days').prop('required',true);
       } else{
           $('.free-day').hide();
           $('#for_days').prop('required',false);
       }
    });
  </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/coupon/create.blade.php ENDPATH**/ ?>