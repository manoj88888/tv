        ...
        <div class="container__child signup__form">
          <form method="POST" action="<?php echo e(route('password.request')); ?>">
            ...
            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
              ...
              <input id="email" type="text" class="form-control" name="email" placeholder="<?php echo e(__('staticwords.enteryouremail')); ?>" value="<?php echo e($email or old('email')); ?>" required autofocus>
            ...
            <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
              <label for="password"><?php echo e(__('staticwords.newpassword')); ?></label>
              <input id="password" type="password" class="form-control" name="password" placeholder="<?php echo e(__('staticwords.enteryournewpassword')); ?>" required>
            ...
            <div class="form-group">
              ...
              <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="<?php echo e(__('staticwords.enteryourpassowrdagain')); ?>" required>
            </div>
            <div class="m-t-lg">
              <input class="btn btn--form btn--form-login" type="submit" value="<?php echo e(__('staticwords.resetpassword')); ?>" />
            </div>
          </form>
        </div>
      </div>
...
<?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>