          ...
          <div class="api-main-block">
            ...
            <div class="payment-gateway-block">
              <div class="form-group">
                <div class="row">
                  <div class="col-xs-6">
                    <?php echo Form::label('kingspay_payment', __('adminstaticwords.KINGSPAYPAYMENT')); ?>

                  </div>
                  <div class="col-xs-5 text-right">
                    <label class="switch">
                      <?php echo Form::checkbox('kingspay_payment', 1, $config->kingspay_payment, ['class' => 'checkbox-switch']); ?>
              ...
              <div style="<?php echo e($config->kingspay_payment==1 ? "" : "display: none"); ?>" id="kingspay_box" class="row">
                <div class="col-md-6">
                  <div class="form-group<?php echo e($errors->has('KINGSPAY_KEY') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('KINGSPAY_KEY', __('adminstaticwords.KINGSPAYKEY')); ?>

                      <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('adminstaticwords.PleaseEnterKingsPayKey')); ?>"></i>
                      <?php echo Form::text('KINGSPAY_KEY', null, ['class' => 'form-control']); ?>

            
                      <small class="text-danger"><?php echo e($errors->first('KINGSPAY_KEY')); ?></small>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="search form-group<?php echo e($errors->has('KINGSPAY_SECRET') ? ' has-error' : ''); ?>">
                      
                          <?php echo Form::label('KINGSPAY_SECRET', __('adminstaticwords.KINGSPAYSECRETKEY')); ?>

                          <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('adminstaticwords.PleaseEnterKingsPaySecretKey')); ?>"></i>
                          
            
                          <input type="password" id="kingspay-password-field" name="KINGSPAY_SECRET" value="<?php echo e($env_files['KINGSPAY_SECRET']); ?>">
            
                          <span toggle="#kingspay-password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                      <small class="text-danger"><?php echo e($errors->first('KINGSPAY_SECRET')); ?></small>
                  </div>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/config/api.blade.php ENDPATH**/ ?>