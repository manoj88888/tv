...
<?php $__env->startSection('title',__('adminstaticwords.PricingTextSetting')); ?>
<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><?php echo e(__('adminstaticwords.PricingTextSetting')); ?></h4>
      ...
      <div class="row">
        <?php echo Form::model($pricingtexts, ['method' => 'POST', 'action' => 'CustomStyleController@pricingTextUpdate']); ?>
         ...
         <div class="form-group<?php echo e($errors->has('package_id') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('package_id', __('adminstaticwords.SelectPackage')); ?>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group<?php echo e($errors->has('title1') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('title1',__('adminstaticwords.title1')); ?>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group<?php echo e($errors->has('title2') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('title2', __('adminstaticwords.title2')); ?>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group<?php echo e($errors->has('title3') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('title3', __('adminstaticwords.title3')); ?>
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="form-group<?php echo e($errors->has('title4') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('title4', __('adminstaticwords.title4')); ?>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group<?php echo e($errors->has('title5') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('title5', __('adminstaticwords.title5')); ?>
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="form-group<?php echo e($errors->has('title6') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('title6', __('adminstaticwords.title6')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/customstyle/pricingText.blade.php ENDPATH**/ ?>