                ...
                <div class="form-group<?php echo e($errors->has('url_480') ? ' has-error' : ''); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      <p class="inline info"> - <?php echo e(__('adminstaticwords.VideoUrlFor480Quality')); ?></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/admin/tvseries/episodes.blade.php ENDPATH**/ ?>