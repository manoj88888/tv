  ...
  <?php echo $__env->make('modal.agewarning', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if(isset($movie)): ?>
      <?php if($movie->poster != null): ?>
        <div id="big-main-poster-block" class="big-main-poster-block" style="background-image: url('<?php echo e(url('images/movies/posters/'.$movie->poster)); ?>');">
          <div class="overlay-bg"></div>
        </div>
      <?php else: ?>
        <div id="big-main-poster-block" class="big-main-poster-block" style="background-image: url('<?php echo e(url('images/default-poster.jpg')); ?>');">
          <div class="overlay-bg"></div>
        </div>
      <?php endif; ?>
    <?php endif; ?>
    <?php if(isset($season)): ?>
      <?php if($season->poster != null): ?>
        <div id="big-main-poster-block" class="big-main-poster-block" style="background-image: url('<?php echo e(url('images/tvseries/posters/'.$season->poster)); ?>');">
          <div class="overlay-bg"></div>
        </div>
      <?php elseif($season->tvseries->poster != null): ?>
        <div id="big-main-poster-block" class="big-main-poster-block" style="background-image: url('<?php echo e(url('images/tvseries/posters/'.$season->tvseries->poster)); ?>');">
          <div class="overlay-bg"></div>
        </div>
      <?php else: ?>
        <div id="big-main-poster-block" class="big-main-poster-block" style="background-image: url('<?php echo e(url('images/default-poster.jpg')); ?>');">
              ...
              <div class="full-movie-dtl-block">
                ...
                <select style="width:20%;-webkit-box-shadow: none;box-shadow: none;color: #FFF;background: #000;display: block;clear: both;border: 1px solid #666;border-radius: 0;" name="" id="selectseason" class="form-control">
                  <?php $__currentLoopData = $season->tvseries->seasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allseason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e($season->id == $allseason->id ? "selected" : ""); ?> value="<?php echo e($allseason->id); ?>"> <?php echo e(__('staticwords.season')); ?><?php echo e($allseason->season_no); ?> </option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <br>
                <div class="imdb-ratings-block">
    ...
    <?php if(isset($movie->movie_series) && $movie->series != 1): ?>
      <?php if(count($movie->movie_series) > 0): ?>
        <div class="container-fluid movie-series-section search-section">
          <h5 class="movie-series-heading"><?php echo e(count($movie->movie_series)); ?> Series </h5>
          <div>
                  ...
                  <div class="col-sm-3">
                    <div class="movie-series-img">
                      <?php if($single_series->thumbnail != null || $single_series->thumbnail != ''): ?>
                        <img src="<?php echo e(url('images/movies/thumbnails/'.$single_series->thumbnail)); ?>" class="img-responsive" alt="genre-image">
                      <?php endif; ?>
                    </div>
                  </div>
    ...
    <?php if(isset($filter_series) && $movie->series == 1): ?>
      <?php if(count($filter_series) > 0): ?>
        <div class="container-fluid movie-series-section search-section">
          <h5 class="movie-series-heading">SEries<?php echo e(count($filter_series)); ?></h5>
          <div>
                  ...
                  <div class="col-sm-3">
                    <div class="movie-series-img">
                      <?php if($series->thumbnail != null): ?>
                        <img src="<?php echo e(url('images/movies/thumbnails/'.$series->thumbnail)); ?>" class="img-responsive" alt="genre-image">
                      <?php endif; ?>
                    </div>
                  </div>
                  <div class="col-sm-7 pad-0">
                    ...
                    <div class="des-btn-block des-in-list">
                      ...
                      <?php elseif($catlog ==1 && $auth): ?>
                        <?php if(isset($wishlist_check->added)): ?>
                          <a onclick="addWish(<?php echo e($series->id); ?>,'<?php echo e($series->type); ?>')" class="addwishlistbtn<?php echo e($series->id); ?><?php echo e($series->type); ?> btn-default"><?php echo e($wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')); ?></a>
                        <?php else: ?>
                          <a onclick="addWish(<?php echo e($series->id); ?>,'<?php echo e($series->type); ?>')" class="addwishlistbtn<?php echo e($single_series->id); ?><?php echo e($series->type); ?> btn-default"><?php echo e(__('staticwords.addtowatchlist')); ?></a>
                        <?php endif; ?>
                      <?php endif; ?>
                  ...
                  <div class="col-sm-3">
                    <div class="movie-series-img">
                      ...
                      <?php elseif($episode->thumbnail != null): ?>
                        <img src="<?php echo e(url('images/tvseries/episodes/'.$episode->thumbnail)); ?>" class="img-responsive" alt="genre-image">
                      <?php else: ?>
                        <img src="<?php echo e(url('images/default-thumbnail.jpg')); ?>" class="img-responsive" alt="genre-image">
                      <?php endif; ?>
                    </div>
                  </div>
                    ...
                    <?php if(isset($episode->multilinks) &&  count($episode->multilinks) >0): ?>
                      <?php if(Auth::user() && $subscribed==1): ?>
                        <?php if(in_array(1, $elc)): ?>
                         ...
                         <button type="button" class="btn-default" data-toggle="collapse" data-target="#downloadtvseries"><?php echo e(__('staticwords.download')); ?></button>
...
<?php if(isset($season)): ?>
 <?php if($configs->comments==1): ?>
   ...
   <!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active" style="z-index:999;"><a href="#showcomment" aria-controls="showcomment" role="tab" data-toggle="tab" ><?php echo e(__('staticwords.comment')); ?></a></li>
    <?php if($subscribed == 1): ?>
                      ...
                      <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block<?php echo e($item->id); ?><?php echo e($item->type); ?>">
                       <?php if($auth && $subscribed == 1): ?>
                        <a href="<?php echo e(url('show/detail/'.$item->season_slug)); ?>">
                          <?php if($item->thumbnail != null): ?>
                            <img data-src="<?php echo e(url('images/tvseries/thumbnails/'.$item->thumbnail)); ?>" class="img-responsive owl_lazy" alt="genre-image">
                          <?php elseif($item->tvseries->thumbnail != null): ?>
                            
                            <img src="<?php echo e(url('images/tvseries/thumbnails/'.$item->tvseries->thumbnail)); ?>" class="img-responsive owl_lazy" alt="genre-image">
                          <?php else: ?>
                            <img data-src="<?php echo e(url('images/default-thumbnail.jpg')); ?>" class="img-responsive owl_lazy" alt="genre-image">
                          <?php endif; ?>
                        </a>
                        <?php else: ?>
                        <a href="<?php echo e(url('show/guest/detail/'.$item->season_slug)); ?>">
                          <?php if($item->thumbnail != null): ?>
                            <img data-src="<?php echo e(url('images/tvseries/thumbnails/'.$item->thumbnail)); ?>" class="img-responsive owl_lazy" alt="genre-image">
                          <?php elseif($item->tvseries->thumbnail != null): ?>
                            <img data-src="<?php echo e(url('images/tvseries/thumbnails/'.$item->tvseries->thumbnail)); ?>" class="img-responsive owl_lazy" alt="genre-image">
                          <?php else: ?>
                            <img data-src="<?php echo e(url('images/default-thumbnail.jpg')); ?>" class="img-responsive owl_lazy" alt="genre-image">
                          <?php endif; ?>
                        </a>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><?php echo e(__('staticwords.shareiton')); ?></h4>
            </div>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alphatvcpanel/app.alphatv.global/resources/views/movie_single.blade.php ENDPATH**/ ?>