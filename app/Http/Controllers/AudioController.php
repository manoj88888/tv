...
class AudioController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        <a href="' . url('audio/detail', $audio->id) . '" data-toggle="tooltip" data-original-title="Page Preview" target="_blank" class="btn-default btn-floating"><i class="material-icons">desktop_mac</i></a>';
                    ...
                    $btn .= ' <a href="' . route('audio.edit', $audio->id) . '" data-toggle="tooltip" data-original-title="'.__('adminstaticwords.Edit').'" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a><button type="button" class="btn-danger btn-floating" data-toggle="modal" data-target="#deleteModal' . $audio->id . '"><i class="material-icons">delete</i> </button></div>';
