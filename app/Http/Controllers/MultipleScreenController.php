...
class MultipleScreenController extends Controller
{
    ...
    public function newupdate(Request $request, $id)
    {
        ...
        if ($screenNo == 1) {
            ...
            $query = Multiplescreen::where('user_id', $id)->update(['device_mac_3' => $macaddress, 'screen_3_used' => 'YES', 'activescreen' => $request->screen]);
    ...
    public function manageprofile($id)
    {
        ...
        return view('newmanageprofile', compact('result'));
    }
