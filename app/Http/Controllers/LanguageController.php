...
class LanguageController extends Controller
{
    ...
    public function staticword($lang)
    {
        ...
        if (isset($findlang)) {
            ...
            if (file_exists('../resources/lang/' . $findlang->local . '/staticwords.php')) {
                ...
                $adminfile = file_get_contents("../resources/lang/$findlang->local/adminstaticwords.php");
                return view('admin.language.staticword', compact('findlang', 'file','adminfile'));
            } else {
                ...
                if (is_dir('../resources/lang/' . $findlang->local)) {
                    ...
                    copy("../resources/lang/en/adminstaticwords.php", '../resources/lang/' . $findlang->local . '/adminstaticwords.php');
                    $adminfile = file_get_contents("../resources/lang/$findlang->local/adminstaticwords.php");
                    ...
                    return view('admin.language.staticword', compact('findlang', 'file','admin'));
                }
    ...
    public function editStaticTrans($langCode)
    {
        ...
        if (isset($findlang)) {
            ...
            if (file_exists('../resources/lang/' . $findlang->local . '/staticwords.php')) {
                ...
                $adminfile = file_get_contents("../resources/lang/$findlang->lang_code/adminstaticwords.php");
                return view('admin.language.staticword', compact('findlang', 'file','adminfile'));
            } else {
    ...
    public function updateStaticTrans(Request $request, $langCode)
    {
     ...
     public function updateAdminStaticTrans(Request $request, $langCode)
    {
        $findlang = Language::where('local', '=', $langCode)->first();
        if (isset($findlang)) {

            if($request->admintransfile){
                 $admintransfile = $request->admintransfile;
                file_put_contents('../resources/lang/' . $findlang->local . '/adminstaticwords.php', $admintransfile . PHP_EOL);
                return back()->with('updated', 'Admin Language Translations Updated !');
            }
