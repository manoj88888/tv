    ...
    { 
        ...
        if($user){
            ...
            try{
                ...
                // });
                Mail::to($request->email)->send(new SendOTPEmail($code, $logo, $company, $request->email)); 
                // $test = View::make('forgotemail', compact('code', 'logo', 'company'))->render();
                // echo $test;
                // die;
                $user->code = $code;
                $user->save();
    ...
    { 
        ...
        if($accessToken){
            ...
            if($activesubsription){
                ...
                if($current_date <= $activesubsription->subscription_to ){
